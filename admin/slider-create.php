...
if(isset($_POST['submit'])){
   ...
   */
    ...
    $t_file = $t_dir . round(microtime(true)) . '.' . end($temp);
    ...
    if(move_uploaded_file($_FILES['image']['tmp_name'], $t_file)){
        $image = $t_file;
            ...
            if($stmt->execute()){
              ...
              $_SESSION['slider_ok'] = " slider has been added succesfully";  // getting alert session 
              $_SESSION['slider_code'] = "success";          // getting alert session 
              $_SESSION['slider_title'] = $_POST['h_title'];  // getting  slider header name  in session 
              $message = "Success!";
              header("Location:slider-show.php");
          }
          else{
            $_SESSION['slider_error'] = " slider can not be added";
            $_SESSION['slider_code'] = "danger";
            $_SESSION['slider_title'] = $_POST['h_title'];
                ...
                <div class="tile">
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit" name="submit"><i
                                class="fa fa-fw fa-lg fa-check-circle"></i>Add Slide</button>&nbsp;&nbsp;&nbsp;<a
                            class="btn btn-secondary" href="slider-show.php"><i
...
<!-- ********************* Bootstrap notify *************************************** -->
    ...
    <?php 
if (isset($_SESSION['slider_error']) &&  $_SESSION['slider_error'] != '')
{
  ?>
