...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Edit Teachers</h1>
      ...
      <div class="row bg-light">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title text-center">Edit teacher Details</h3>
            ...
            <form action="teacher-update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="radio" name="gender" id="male" value="1" <?php if($gender == 1) echo 'checked="checked"' ;?>>
                  <label for="male">Male</label>&nbsp;&nbsp;
                  <input type="radio" name="gender" id="female" value="0" <?php if($gender == 0) echo 'checked="checked"'; ?>>
                ...
                <div class="form-group">
                  ...
                  <select name="e_qualification" id="e_qualification" class="form-control">
                    ...
                    <option value="5"<?php if($e_qualification == 5) echo "selected"; ?>>BSS</option>
                    <option value="6"<?php if($e_qualification == 6) echo "selected"; ?>>MA</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <img src="<?php echo $image; ?>" alt="!" height="80" >
        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Submit</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="teacher-show.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
            </form>
          </div>
        </div>
